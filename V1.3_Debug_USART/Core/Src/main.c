...
int main(void)
{
  ...
  /* Tone 1 - 2000 Hz*/
  __HAL_TIM_SET_PRESCALER(&htim3,15U);
  HAL_TIM_GenerateEvent(&htim3, TIM_EVENTSOURCE_UPDATE);
  HAL_Delay(100U);

	/* Tone 2 - 2667 Hz*/
	__HAL_TIM_SET_PRESCALER(&htim3, 11U);
	HAL_TIM_GenerateEvent(&htim3, TIM_EVENTSOURCE_UPDATE);
	HAL_Delay(100U);

	/* Tone 2 - 2667 Hz*/
	__HAL_TIM_SET_PRESCALER(&htim3, 7U);
	HAL_TIM_GenerateEvent(&htim3, TIM_EVENTSOURCE_UPDATE);
	HAL_Delay(100U);
