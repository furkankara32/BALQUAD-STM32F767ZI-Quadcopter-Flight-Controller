...
The LEDs toggle every 1 second using:
...
Each completed development stage is stored as a separate STM32CubeIDE project.
...
This makes it possible to review and test each stage independently.
